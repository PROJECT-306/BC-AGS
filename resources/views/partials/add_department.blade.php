<!-- Alpine.js Add Department Modal -->
        ...
        <div @click.away="openAdd = false" class="bg-white w-full max-w-xl p-6 rounded-lg shadow-lg">
            ...
            <form method="POST" action="{{ route('departments.store') }}" class="space-y-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="department_name" id="department_name" class="w-full p-2 rounded" required placeholder="Enter department name">
                </div>
