        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-black overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-black border-b border-gray-200">
                    <h3 class="text-xl font-bold mb-4 text-white">List of Semesters</h3>
                    ...
                    <table class="min-w-full bg-black text-white border border-gray-200">
                        <thead>
                            <tr>
                                <th class="px-6 py-4 text-left">Semester Name</th>
                        ...
                        <tbody>
                            @foreach ($semesters as $semester)
                                <tr class="hover:bg-white hover:text-black">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{route ('semesters.edit', $semester->semester_id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</a>
