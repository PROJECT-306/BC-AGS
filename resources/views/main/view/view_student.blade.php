        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-black overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-[#EAF8E7] border-b border-gray-200">
                    <h3 class="text-xl font-bold mb-4">List of Students</h3>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-2 items-center justify-start">
                                            ...
                                            <form method="POST" action="{{ route('students.destroy', $student->student_id) }}" 
                                                onsubmit="return confirm('Are you sure you want to delete this student? This action cannot be undone.');" class="inline-block">
                                                @csrf
                                                @method('DELETE')
