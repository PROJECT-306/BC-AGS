        ...
        <div class="max-w-4xl mx-auto sm:px-4 lg:px-6">
            <div class="bg-black overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 bg-green-50 border-b border-gray-200">
                    ...
                    <a href="{{ route('user-roles.create') }}" class="inline-block bg-blue-500 text-white font-semibold py-1 px-3 rounded-md hover:bg-blue-700 mb-4">
                        Add a User Role
                    </a>
...
>>>>>>> origin/kyle-policies
                        <thead>
                            <tr class="text-gray-800">
                                <th class="px-4 py-3 text-left">User Role Name</th>
                                <th class="px-4 py-3 text-left">Role Number</th>
                        ...
                        <tbody>
                            @foreach ($userRoles as $userRole)
                                <tr class="hover:bg-gray-100 transition-colors">
                                    <td class="px-4 py-3">{{ $userRole->user_role_name }}</td>
                                    <td class="px-4 py-3">{{ $userRole->user_role_number }}</td>
                                    <td class="px-4 py-3">
                                        <div class="flex space-x-2 items-center justify-start">
                                            <a href="{{ route('user-roles.edit', $userRole->user_role_id) }}" 
