        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-black overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-black border-b border-gray-200">
                    <h3 class="text-xl font-bold mb-4 text-white">Edit User Role</h3>

                    <form method="POST" action="{{ route('user-roles.update', $userRoles->user_role_id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="user_role_number" name="user_role_number" 
                                   class="w-full p-2 border rounded-md" value="{{ old('user_role_number', $userRoles->user_role_number) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="user_role_name" name="user_role_name" 
                                   class="w-full p-2 border rounded-md" value="{{ old('user_role_name', $userRoles->user_role_name) }}" required>
