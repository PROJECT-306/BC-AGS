    ...
    <main class="flex-1 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-[#EAF8E7] shadow rounded-2xl p-6">
                ...
                <p class="mt-2 text-3xl font-bold text-green-600">{{ $totalInstructors }}</p>
            </div>

            {{-- Total Courses --}}
            <div class="bg-[#EAF8E7] shadow rounded-2xl p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-gray-800">Total Courses</h3>
                <p class="mt-2 text-3xl font-bold text-green-600">{{ $totalCourses }}</p>
            </div>

            {{-- Subjects Assigned --}}
            <div class="bg-[#EAF8E7] shadow rounded-2xl p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-gray-800">Subjects Assigned</h3>
                <p class="mt-2 text-3xl font-bold text-green-600">{{ $totalSubjectsAssigned }}</p>
            </div>
